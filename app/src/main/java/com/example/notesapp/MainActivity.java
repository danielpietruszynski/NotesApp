...
public class MainActivity extends AppCompatActivity {
                ...
                else
                {
                    ...
                    firebaseAuth.signInWithEmailAndPassword(mail,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            {
                                Toast.makeText(getApplicationContext(),"Konto nie istnieje",Toast.LENGTH_SHORT).show();
    ...
    private void checkmailverfication()
    {
        ...
        {
            mprogressbarofmainactivity.setVisibility(View.INVISIBLE);
            Toast.makeText(getApplicationContext(),"Najpierw zweryfikuj swój email",Toast.LENGTH_SHORT).show();
